...
class SdpParser extends Parser {
   ...
   {  Parser par=new Parser(str,index);
    ...
    public SdpField parseSdpField() {
        int begin = index;
        while (begin >= 0 && begin < str.length() - 1 && str.charAt(begin + 1) != '=')
            begin = str.indexOf("\n", begin);
    ...
    public SdpField parseSdpField(char type) {
        ...
        if (!str.startsWith(type + "=", index)) {
            ...
            if (begin < 0) {  // return null if no type SdpField has been found
                return null;
            }
            index = begin + 1;
        }
    ...
    public OriginField parseOriginField() {
        ...
        if (sf != null) return new OriginField(sf);
        else return null;
    }
    ...
    public MediaField parseMediaField() {
        ...
        if (sf != null) return new MediaField(sf);
        else return null;
    }
    ...
    public ConnectionField parseConnectionField() {
        ...
        if (sf != null) return new ConnectionField(sf);
        else return null;
    }
    ...
    public SessionNameField parseSessionNameField() {
        ...
        if (sf != null) return new SessionNameField(sf);
        else return null;
    }
    ...
    public TimeField parseTimeField() {
        ...
        if (sf != null) return new TimeField(sf);
        else return null;
    }
    ...
    public AttributeField parseAttributeField() {
        ...
        if (sf != null) return new AttributeField(sf);
        else return null;
    }
