...
public class MD5OTP {
   ...
   {  init(bsize,key,iv);
     ...
     */
    public static int encrypt(byte[] in_buff, int in_offset, int in_len, byte[] out_buff, int out_offset, byte[] key) {  // choose a random IV
     ...
     * Encrypts an array of bytes. An IV is chosen and written at the top.
     */
    public static byte[] encrypt(byte[] m, byte[] key) {  // choose a random IV
        byte[] iv = Random.nextBytes(16);
        // do encryption
     ...
     */
    public static int decrypt(byte[] in_buff, int in_offset, int in_len, byte[] out_buff, int out_offset, byte[] key) {  // read the IV
