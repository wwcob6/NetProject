...
public class PipeOutputStream extends OutputStream {
     ...
     */
    public void write(byte[] b) throws IOException {  //for (int i=0; i< b.length; i++) pipe.write(b[i]);
        pipe.write(b);
    }
     ...
     */
    public void write(byte[] buff, int off, int len) throws IOException {  //int end=off+len;
