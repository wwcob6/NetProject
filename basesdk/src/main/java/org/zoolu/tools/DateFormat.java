...
public class DateFormat {
     ...
     */
    public static String formatHHMMSS(Date date) {  //DateFormat df=new SimpleDateFormat("HH:mm:ss.SSS EEE dd MMM yyyy",Locale.US);
     ...
     */
    public static String formatEEEddMMM(Date date) {  //DateFormat df=new SimpleDateFormat("EEE, dd MMM yyyy hh:mm:ss 'GMT'",Locale.US);
        //return df.format(date);
      /*
      String str=date.toString(); // dow mon dd hh:mm:ss zzz yyyy
      int len=str.length();
     ...
     */
    public static Date parseEEEddMMM(String str, int index) {  //DateFormat df=new SimpleDateFormat("EEE, dd MMM yyyy hh:mm:ss 'GMT'",Locale.US);
        //return df.format(date);
        Calendar cal = Calendar.getInstance();
        char[] delim = {' ', ',', ':'};
