...
public class PipeInputStream extends InputStream {
     ...
     */
    public int read(byte[] buff) throws IOException {  //int length=(b.length<pipe.length())? b.length : pipe.length();
     ...
     */
    public int read(byte[] buff, int off, int len) throws IOException {  //int length=(len<pipe.length())? len : pipe.length();
        //int end=off+length;
     ...
     */
    public long skip(long n) throws IOException {  //int length=(n<pipe.length())? (int)n : pipe.length();
