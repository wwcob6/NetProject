...
public class MultiTable {
    ...
    public Enumeration elements() {
        ...
        for (Enumeration keys = keys(); keys.hasMoreElements(); ) {  //elements.addAll(((Vector)keys.nextElement()));
            for (Enumeration e = ((Vector) keys.nextElement()).elements(); e.hasMoreElements(); )
