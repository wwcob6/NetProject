...
public class BinTools {
     ...
     */
    public static boolean compare(byte[] a, byte[] b) {  //if (a.length!=b.length) return false;
     ...
     */
    public static short uByte(byte b) {  //return (short)(((short)b+256)&0xFF);
     ...
     */
    public static long uWord(int n) {  //long Ox1OOOOOOOO=(long)1<<32;
     ...
     */
    public static byte[] hexStringToBytes(String str, int len) {  // if the string is of the form xx:yy:zz:ww.., remove all ':' first
        if (str.indexOf(":") >= 0) {
            String aux = "";
            char c;
