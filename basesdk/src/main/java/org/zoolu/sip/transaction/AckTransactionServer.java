...
public class AckTransactionServer extends Transaction implements SipProviderListener {
        ...
        if (statusIs(STATE_PROCEEDING) && msg.isRequest()) {
         ...
         {  doTerminate();
            ...
            transaction_listener=null;
                ...
                printWarning(msg.getRequestLine().getMethod() + " method erroneously passed to this trasaction", Log.LEVEL_HIGH);
        }
    }
    ...
    protected void printLog(String str, int level) {
        if (log != null)
            log.println("AckTransactionServer#" + transaction_sqn + ": " + str, Transaction.LOG_OFFSET + level);
    }
