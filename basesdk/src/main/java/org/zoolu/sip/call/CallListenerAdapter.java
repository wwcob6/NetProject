...
public abstract class CallListenerAdapter implements ExtendedCallListener {
   ...
   {  return audioSession(port,0,"PCMU",8000);
     ...
     */
    public void onCallInvite(Call call, NameAddress callee, NameAddress caller, String sdp, Message invite) {  //printLog("INCOMING");
        call.ring();
        // accept immediatly
     ...
     */
    public void onCallModify(Call call, String sdp, Message invite) {  //printLog("RE-INVITE/MODIFY");
        String local_session;
        if (sdp != null && sdp.length() > 0) {
            SessionDescriptor remote_sdp = new SessionDescriptor(sdp);
            SessionDescriptor local_sdp = new SessionDescriptor(call.getLocalSessionDescriptor());
     ...
     */
    public void onCallProgress(Call call, Message resp) {  //printLog("PROGRESS");
    }
     ...
     */
    public void onCallRefused(Call call, String reason, Message resp) {  //printLog("REFUSED ("+reason+")");
    }
     ...
     */
    public void onCallRedirected(Call call, String reason, Vector contact_list, Message resp) {  //printLog("REDIRECTION ("+reason+")");
     ...
     */
    public void onCallReInviteRefused(Call call, String reason, Message resp) {  //printLog("RE-INVITE-REFUSED ("+reason+")/CALL");
    }
     ...
     */
    public void onCallCancel(Call call, Message cancel) {  //printLog("CANCELING");
    }
     ...
     */
    public void onCallBye(Call call, Message bye) {  //printLog("CLOSING");
    }
     ...
     */
    public void onCallTransfer(ExtendedCall call, NameAddress refer_to, NameAddress refered_by, Message refer) {  //printLog("REFER-TO/TRANSFER");
    }
     ...
     */
    public void onCallAttendedTransfer(ExtendedCall call, NameAddress refer_to, NameAddress refered_by, String replcall_id, Message refer) {  //printLog("REFER-TO/TRANSFER");
    }
     ...
     */
    public void onCallTransferSuccess(ExtendedCall call, Message notify) {  //printLog("TRANSFER SUCCESS");
    }
     ...
     */
    public void onCallTransferFailure(ExtendedCall call, String reason, Message notify) {  //printLog("TRANSFER FAILURE");
    }
