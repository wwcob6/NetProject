...
public class OptionsServer implements SipProviderListener {
    ...
    public void halt() {
        if (sip_provider != null)
            sip_provider.removeSelectiveListener(new MethodId(SipMethods.OPTIONS));
        sip_provider = null;
        log = null;
    }
     ...
     */
    public void onReceivedMessage(SipProvider sip_provider, Message msg) {  // respond to OPTIONS request
