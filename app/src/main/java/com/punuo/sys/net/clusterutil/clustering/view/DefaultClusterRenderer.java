...
package com.punuo.sys.net.clusterutil.clustering.view;
...
import com.punuo.sys.net.clusterutil.MarkerManager;
import com.punuo.sys.net.clusterutil.clustering.Cluster;
import com.punuo.sys.net.clusterutil.clustering.ClusterItem;
import com.punuo.sys.net.clusterutil.clustering.ClusterManager;
import com.punuo.sys.net.clusterutil.projection.Point;
import com.punuo.sys.net.clusterutil.projection.SphericalMercatorProjection;
import com.punuo.sys.net.clusterutil.ui.IconGenerator;
...
import static com.punuo.sys.net.clusterutil.MarkerManager.MAX_DISTANCE_AT_ZOOM;

/**
 * The default view for a ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.punuo.sys.net.clusterutil.clustering.view.ClusterRenderer<T> {
        ...
        mClusterManager.getMarkerCollection()
                .setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(Marker marker) {
                        return mItemClickListener != null && mItemClickListener
    ...
    private com.punuo.sys.net.clusterutil.ui.SquareTextView makeSquareTextView(
            Context context) {
        com.punuo.sys.net.clusterutil.ui.SquareTextView squareTextView =
                new com.punuo.sys.net.clusterutil.ui.SquareTextView(context);
