...
package com.punuo.sys.net.clusterutil.clustering.algo;
...
import com.punuo.sys.net.clusterutil.projection.Bounds;
...
import com.punuo.sys.net.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.punuo.sys.net.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.punuo.sys.net.clusterutil.clustering.algo
